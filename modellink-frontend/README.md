# Modellink Frontend (React)

## Project Overview

**Modellink Frontend** is a single-page React application built using **Vite** that showcases model profiles and allows basic CRUD (Create, Read, Update, Delete) operations on models.
